...
namespace CustomPreLaunchChecks
{
    internal class Log
    {
        ...
        {
            UnityEngine.Debug.Log("CPLC: " + message);
        }
        ...
        {
            UnityEngine.Debug.LogWarning("CPLC: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
            UnityEngine.Debug.LogError("CPLC: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
#if DEBUG
            UnityEngine.Debug.Log("CPLC: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
#endif
        }
